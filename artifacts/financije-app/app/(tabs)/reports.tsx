...
import { formatCurrency } from "@/components/CurrencyText";
...
export default function ReportsScreen() {
  ...
  const { getCategoryTotals, getTransactionsByMonth, getMonthlyTrends } = useFinance();
      ...
      >
        ...
        <View style={styles.summaryRow}>
          <View style={[styles.summaryCard, { backgroundColor: "rgba(34,197,94,0.1)", borderColor: "rgba(34,197,94,0.3)" }]}>
            ...
            <Text style={[styles.summaryAmount, { color: colors.income }]}>{formatCurrency(incomeTotal)}</Text>
          </View>
          <View style={[styles.summaryCard, { backgroundColor: "rgba(239,68,68,0.1)", borderColor: "rgba(239,68,68,0.3)" }]}>
            ...
            <Text style={[styles.summaryAmount, { color: colors.expense }]}>{formatCurrency(expenseTotal)}</Text>
          </View>
        </View>
